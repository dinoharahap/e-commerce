...
<div class="flex flex-wrap justify-center mt-4 sm:mt-6 gap-2 sm:gap-3 px-4 sm:px-6">
    ...
    <a href="/menu/ayam" class="border px-3 sm:px-4 py-2 rounded-full hover:bg-gray-100 transition text-xs sm:text-sm">Ayam Geprek</a>
    ...
    <a href="/menu/paket" class="bg-orange-500 text-white px-3 sm:px-4 py-2 rounded-full hover:bg-orange-600 transition text-xs sm:text-sm">Paket Mahasiswa</a>
</div>
