...
<div class="flex justify-center mt-6 space-x-4">
    ...
    <a href="/menu/minuman" class="border px-4 py-2 rounded-full hover:bg-gray-100 transition">Minuman</a>
    <a href="/menu/paket" class="bg-orange-500 text-white px-4 py-2 rounded-full hover:bg-orange-600 transition">Paket Mahasiswa</a>
</div>
